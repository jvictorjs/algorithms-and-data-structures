...
// var totalLines = readline(); // first line of input usually gives the no. of test cases,i.e, the no. of lines ahead.
// var currentLine; // declaring the variable outside the loop
// for (var i = 0; i < totalLines; i++) {
    var currentLine = readline()
    var distinctChars = ''
    for (var j = 0; j < currentLine.length; j++) {
        if (distinctChars.indexOf(currentLine.charAt(j)) > -1) {
    
        } else {
            distinctChars += currentLine.charAt(j)
        }
    }
